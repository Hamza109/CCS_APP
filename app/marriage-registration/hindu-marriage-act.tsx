...
import { hinduMarriageActContent } from "../../src/data/hinduMarriageAct";

const FILE_BASE_URL = "http://10.149.13.209/ccsproject/";

type ItemType =
  | { type: "section"; heading: string; description: string }
  | {
      type: "download";
      label: string;
      file_url: string;
...
const HinduMarriageActScreen: React.FC = () => {
  const sections = hinduMarriageActContent.sections;
  ...
  return (
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      <BlueHeader title={hinduMarriageActContent.title} />
...
export default HinduMarriageActScreen;
